...
namespace DotNetDemos.CSharpExamples
{
	class InterfacesExamples
	{
		...
		internal class EmployeeAsGenericIComparable : Employee, IComparable<EmployeeAsGenericIComparable>, IEquatable<EmployeeAsGenericIComparable>
		{
			...
			//to return values that are consistent with CompareTo. Define the is greater than operator.
		 ...
		 * - It requires that implementing types define a single method, CompareTo(Object), that indicates whether 
		 *   the position of the current instance in the sort order is before, after, or the same as a second object of the same type.
		 ...
		 *   1. Less than zero > The current instance precedes the object specified by the CompareTo method in the sort order.
		 *   2. Zero > This current instance occurs in the same position in the sort order as the object specified by the CompareTo method.
		 *   3. Greater than zero > This current instance follows the object specified by the CompareTo method in the sort order.
		 */
		...
		/**
		 * - Defines methods to support the comparison of objects for equality.(System.Collections.Generic)
		 * - This interface allows the implementation of customized equality comparison for collections.
		 * - The constructor that uses IEqualityComparer let you give a specific Equals/GetHashCode that can be different than 
		 *   the ones defined by your object. Normally the Hashtable will use your object overridden Equals and GetHashCode.
		 */
