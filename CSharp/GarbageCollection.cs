...
namespace DotNetDemos.CSharpExamples
{
    ...
    class DatabaseState : IDisposable
    {
        ...
        ///   collector automatically calls an object's finalizer prior to reclaiming its memory. However, once the 
        ///   Dispose method has been called, it is typically unnecessary for the garbage collector to call the disposed 
