...
namespace DotNetDemos.CSharpExamples
{
	...
	internal enum DesignPatternChoice { Facade = 1, Observer, Singleton, Adapter, AbstractFactory, Builder, Factory, Command, Composite, Decorator };
	public class DesignPatternExamples
	{
		public void DoAction(int choice)
		{

			switch ((DesignPatternChoice)choice)
			{
				case DesignPatternChoice.Facade:
					var obj1 = new FacadeExample();
					break;

				case DesignPatternChoice.Observer:
					var obj2 = new ObserverExample();
					break;

				case DesignPatternChoice.Singleton:
					var obj3 = new SingletonExample();
					break;

				case DesignPatternChoice.Adapter:
					var obj4 = new AdapterExample();
					break;

				case DesignPatternChoice.AbstractFactory:
					var obj5 = new AbstractFactoryExample();
					break;

				case DesignPatternChoice.Builder:
					var obj6 = new BuilderExample();
					break;

				case DesignPatternChoice.Factory:
					var obj7 = new FactoryExample();
					break;

				case DesignPatternChoice.Command:
					var obj8 = new CommandExample();
					break;

				case DesignPatternChoice.Composite:
					var obj9 = new CompositeExample();
					break;

				case DesignPatternChoice.Decorator:
					var obj10 = new DecoratorExample();
					break;
			}
		}
	}
