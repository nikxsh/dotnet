...
namespace WineryStore.Persistence.Datastore
{
	public class WineryContext : DbContext
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			//2. dotnet ef migrations add InitialWineryCreate -s ..\WineryStore.API  (-c contextName) /// Add-Migration InitialWineShopCreate 
			//3. dotnet ef database update -s ..\WineryStore.API /// Update-Database
