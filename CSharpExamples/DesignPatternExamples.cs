...
namespace DotNetDemos.CSharpExamples
{
    ...
    internal enum DesignPatternChoice { Facade = 1, Observer, Singleton, Adapter, AbstractFactory, Builder, Factory, Command, Composite };
        ...
        public void DoAction(int choice)
        {
            ...
            switch ((DesignPatternChoice)choice)
            {
                case DesignPatternChoice.Facade:
                    obj = new FacadeExample();
                    break;

                case DesignPatternChoice.Observer:
                    obj = new ObserverExample();
                    break;
