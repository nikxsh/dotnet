...
namespace DataStructures
{
    public class BinaryTreeExample
    {
        public BinaryTreeExample()
        {
            ...
            {
                new Student { StudentId = 1001, Marks = 75, CompareChoice = compareChoice },
            ...
            binaryTree.Add(new Student { StudentId = 1004, Marks = 10, CompareChoice = compareChoice });
            binaryTree.Add(new Student { StudentId = 1005, Marks = 50, CompareChoice = compareChoice });
            binaryTree.Add(new Student { StudentId = 1006, Marks = 65, CompareChoice = compareChoice });
            binaryTree.Add(new Student { StudentId = 1007, Marks = 40, CompareChoice = compareChoice });
            binaryTree.Add(new Student { StudentId = 1008, Marks = 50, CompareChoice = compareChoice });
            binaryTree.Add(new Student { StudentId = 1009, Marks = 5, CompareChoice = compareChoice });
            binaryTree.Add(new Student { StudentId = 1010, Marks = 15, CompareChoice = compareChoice });
    ...
    class TreeTraversal<T> where T : class
    {
        ...
        /// <summary>
        /// - A way is to go through them level-by-level.
        /// 
        ///                tree
        ///                ----
        ///                 10                  <-- level 0
        ...
        /// <summary>
        /// - It tries to go deeper in the tree before exploring siblings.
        /// - Depth First Traversals > Preorder (Root, Left, Right) using queue
        /// 
        ///                tree
        ///                ----
        ///                 10 
        ...
        /// <summary>
        /// - Depth First Traversals > Preorder (Root, Left, Right)
        /// - If you know you need to explore the roots before inspecting any leaves, you pick pre-order because you will encounter all the roots 
        ...
        /// <summary>
        /// - Depth First Traversals > Inorder (Left, Root, Right)
        ...
        ///   then an in-order traversal should be used.
        /// 
        ///                tree
        ///                ----
        ///                 10 
        ...
        /// <summary>
        /// - Depth First Traversals > Postorder (Left, Right, Root)
        /// - If you know you need to explore all the leaves before any nodes, you select post-order because you don't waste any time inspecting 
